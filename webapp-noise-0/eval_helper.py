...
class EvalHelper:
    ...
    def compute_dice_coefficient_per_instance(self, mask_gt, mask_pred):
    ...
    def eval_image(self,predicted_image,ground_truth_image):
        ...
        predicted_image = Image.open(predicted_image)
        #image = predicted_image.convert("L")
        ...
        dice_coefficient = self.compute_dice_coefficient(ground_truth_array, predicted_array)
